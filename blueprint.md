...
| Red-teamer, Product owner | read | yes | yes | — | none |
| Behavioural scientist, Growth | read | yes | yes | — | none |
| Designer | read | yes | — | yes (screenshots) | none |
| Tester | read | — | — | yes (runs flows) | none |
| Data analyst | read | — | yes (SELECT-only) | — | none |
| Security | read | yes | yes | — | none |
